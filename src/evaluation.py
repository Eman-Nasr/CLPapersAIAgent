"""
evaluation.py  –  Member 4: Evaluation Outputs
=====================================================
...
Run after autoML_Optuna.py has finished:                 
    python -m src.evaluation --output-dir outputs/test3/automl  # uses latest outputs/test* dir
"""
...
{cfg_block}
---
*Generated by evaluation.py — Member 4 evaluation stage only.*
"""
